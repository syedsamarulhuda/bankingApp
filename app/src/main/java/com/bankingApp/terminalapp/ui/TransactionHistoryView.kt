...
class TransactionHistoryView(context: Context, @Nullable attrs: AttributeSet?) :
    ...
    private lateinit var adapter: com.bankingApp.terminalapp.ui.TransactionHistoryAdapter
    ...
    private fun init() {
        ...
        adapter = com.bankingApp.terminalapp.ui.TransactionHistoryAdapter(viewModel.transactions)
